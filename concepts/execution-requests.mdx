...
An execution request is the contract between the caller and the jhansi.io runtime. It describes the work to perform without requiring the caller to manage the underlying environment.
